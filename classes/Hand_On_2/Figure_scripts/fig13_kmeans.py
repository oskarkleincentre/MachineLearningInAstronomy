...
H, FeH_bins, alphFe_bins = np.histogram2d(data['FeH'], data['alphFe'], 150)
...
Xgrid = np.array(Xgrid).reshape((2, 150 * 150)).T

H = clf.predict(scaler.transform(Xgrid)).reshape((150, 150))
